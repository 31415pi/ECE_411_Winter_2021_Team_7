...
#define __DFROBOT_PAJ7620U2_H_NO_STRINGS
#define __DFROBOT_PAJ7620U2_H_NO_ARRAY
#define __DFROBOT_PAJ7620U2_H_NO_DEVICE_ADDRESS
...
#ifndef __DFROBOT_PAJ7620U2_H_NO_DEVICE_ADDRESS
  /*! IIC address of PAJ7620U2, cannot be revised.*/
  const uint8_t _deviceAddr = PAJ7620_IIC_ADDR;
#else
  #define _deviceAddr ((uint8_t)PAJ7620_IIC_ADDR)
#endif
